...
```bash
echo "Production Data" > sample.txt
...
```bash
hdfs dfs -put sample.txt /user/hadoop/production/
...
```bash
hdfs dfs -cp /user/hadoop/production/sample.txt /user/hadoop/backup/sample.txt.bak
...
```bash
hdfs dfs -rm /user/hadoop/production/sample.txt
...
```bash
hdfs dfs -cp /user/hadoop/backup/sample.txt.bak /user/hadoop/production/sample.txt
...
```bash
hdfs dfs -cat /user/hadoop/production/sample.txt
