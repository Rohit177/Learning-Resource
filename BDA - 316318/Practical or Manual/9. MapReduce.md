...
# 2️⃣ Load a Text File into HDFS
...
### 🔹 Copy a text file from local system to HDFS
...
# 3️⃣ WordCount MapReduce Program (Java)
...
### ✅ WordCount.java (Standard Hadoop Program)
...
#  4️⃣ Go to the folder containing `WordCount.java`
...
⚠️ If `/output` exists, delete it first:
